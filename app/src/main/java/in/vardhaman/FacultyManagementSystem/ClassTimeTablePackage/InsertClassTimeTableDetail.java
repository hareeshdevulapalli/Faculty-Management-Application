...
public class InsertClassTimeTableDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(InsertClassTimeTableDetail.this, new DatePickerDialog.OnDateSetListener() {
                            @Override
    ...
    public void submit(View view)
    {
        ...
        {
            Toast.makeText(InsertClassTimeTableDetail.this,"Select date",Toast.LENGTH_SHORT).show();
        }
        else if(subject.equals("")){
            Toast.makeText(InsertClassTimeTableDetail.this,"Enter subject",Toast.LENGTH_SHORT).show();
        }
        else {
            ...
            ClassTimeTableModel model = new ClassTimeTableModel(date, lecture, subject);
            model.save();
            finish();
        }
    }
